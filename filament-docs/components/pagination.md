...
**URL:** https://filamentphp.com/docs/5.x/components/pagination  
**Section:** components  
**Page:** pagination  
**Priority:** medium  
...
You can allow the user to customize the number of items per page by passing an array of options to thepage-optionsattribute. You must also define a Livewire property where the user’s selection will be stored:
...
Extreme links are the first and last page links. You can add them by passing theextreme-linksattribute to the component:
